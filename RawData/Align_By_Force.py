...
emg_start_index = 9319  # select the index belonging to the pulse number where the insole start_index is
emg_end_index = 345657  # select the index belonging to the pulse number where the insole end_index is
