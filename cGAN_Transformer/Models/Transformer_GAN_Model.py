...
class ConvCBNBlock(nn.Module):
    def __init__(self, in_channels, out_channels, cond_embed_dim, use_cbn=True, use_adain=False, use_spectral_norm=False, transpose=False,
        ...
        if activation is None or activation == "linear":
            ...
            self.activation = activation  # Assume already instantiated (e.g., nn.LeakyReLU(0.2))
...
class EMGFusionPatchDiscriminator(nn.Module):
    def __init__(self, num_conditions, cond_embed_dim=128, use_cbn=True, use_adain=False, use_spectral_norm=True, hidden_channels=64,
        ...
        self.cond_projector_for_phi = nn.Linear(cond_embed_dim, C_phi)  # Project co  ndition to match feature channels
...
if __name__ == '__main__':
    ...
    model_summary_obj = summary(model, input_data=(dummy_C, dummy_condition),
