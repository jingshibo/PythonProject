...
old_emg_central, new_emg_central, _, _ = Preprocessing.extractGanTrainingData(modes_generation, old_emg_aligned,
...
Plot_Raw_Data.plot_overlap_sample_all_modes(old_sampled_emg, y_limit=(0, 1))
# Plot_Raw_Data.plot_time_series_and_heatmaps(old_sampled_emg[transition_type], time_start=time_slice_start, time_end=time_slice_end,
# key_label=transition_type, num_samples=5, y_limit=(0, 0.4))
# Plot_Raw_Data.plot_heatmaps_samples(old_sampled_emg[transition_type], time_start=0, time_end=None,
#     key_label=transition_type, num_samples=60, y_limit=(0, 0.4), random_sampling=True, stata='mean')
# Plot_Raw_Data.plot_time_series_samples(old_sampled_emg[transition_type], time_start=0, time_end=None,
...
gen_model = 'one_factor'  # one_factor or two_factors
...
synthetic_dataset, _ = Preprocessing.build_old_cv_dataset(old_remaining_emg, old_sampled_emg, organized_fake_data,
...
_, original_dataset = Preprocessing.build_old_cv_dataset(old_remaining_emg, old_sampled_emg, organized_fake_data,
...
synthetic_dataset, _ = Preprocessing.build_old_cv_dataset_with_noise(old_remaining_emg, old_sampled_emg, modes_generation, snr=25,
...
synthetic_dataset, _ = Preprocessing.build_old_cv_dataset_with_noise(old_remaining_emg, old_sampled_emg, modes_generation, snr=None,
    n_splits=5, n_real_steady_state=50, n_synthetic_transition=50, n_real_transition=5, random_sampling=False)
train_model = Classification_Model.ModelTraining(num_epochs=40, batch_size=32, report_period=10)
