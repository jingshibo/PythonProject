...
Storage.saveClassifyResult(subject, accuracy_old, cm_recall_old, version, result_set, 'classify_with_old', gen_model, num_reference=num_reference)
...
if snr:
    Storage.saveClassifyResult(subject, accuracy_noise, cm_recall_noise, version, result_set, 'classify_with_noisy', gen_model, num_reference=num_reference)
elif num_reference >= 10:  # best transfer learning performance
    Storage.saveClassifyResult(subject, accuracy_noise, cm_recall_noise, version, result_set, 'classify_tf', gen_model, num_reference=num_reference)
else:
