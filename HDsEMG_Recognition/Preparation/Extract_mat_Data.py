...
project = 'HDsEMG_Recognition'
subject = 'Number2'
mat_file = scipy.io.loadmat(f'D:\Data\\{project}\subject_{subject}\\raw_data\\Experiment_Data_20211201_Shibo.mat')
...
##
modes = {'standing': 0, 'level': 1, 'upstairs': 2, 'downstairs': 3, 'upslope': 4, 'downslope': 5}
