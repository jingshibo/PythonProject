...
hdemg_test_data = np.transpose(hdemg_shuffled_groups['group_4']['train_feature_x'], (3, 2, 0, 1))
...
# add_bipolar_data_1 = [data[1, 3] - data[3, 3] for data in hdemg_data]
# add_bipolar_data_2 = [data[9, 3] - data[11, 3] for data in hdemg_data]
...
font_size = 30
for ax, data, number in zip(axs.flatten(), hdemg_data[2:], bipolar_data[2:]):
    ...
    color_bar = fig.colorbar(im, ax=ax, shrink=1)
