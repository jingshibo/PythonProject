...
del processed_old_fake_data, processed_old_real_data
...
noise_new_data = noise_evaluation.generateNoiseData(processed_new_fake_data, reference_new_real_data, num_sample=100, snr=0.05)
# median filtering
