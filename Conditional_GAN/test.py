...
selected_old_fake_data = Dtw_Similarity.extractFakeData(processed_old_fake_data, processed_old_real_data, modes_generation, envelope_frequency=50,
...
# select representative fake data for classification model training
selected_new_fake_data = Dtw_Similarity.extractFakeData(processed_new_fake_data, processed_new_real_data, modes_generation,
    envelope_frequency=50, num_sample=200, num_reference=1, method='select', random_reference=False, split_grids=True)
