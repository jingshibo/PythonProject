...
def plotAdjacentTtest(reorganized_results, legend, title, bonferroni_coeff=1):
    # Create sample data
    data = copy.deepcopy(reorganized_results)
    df_mean = data['accuracy']['statistics']['cm_diagonal_mean_update']
    df_std = data['accuracy']['statistics']['std_update']
    df_pval = data['accuracy']['statistics']['ttest_update']
