## import modules
from Models.Basic_ANN import Ann_Model, CV_Data_Set
import datetime
import os
...
# read feature data
emg_features, emg_feature_reshaped = CV_Data_Set.loadEmgFeature(subject, version, feature_set)
emg_feature_data = CV_Data_Set.removeSomeMode(emg_features)
...
cross_validation_groups = CV_Data_Set.crossValidationSet(fold, emg_feature_data)
normalized_groups = CV_Data_Set.combineIntoDataset(cross_validation_groups, window_per_repetition)
shuffled_groups = CV_Data_Set.shuffleTrainingSet(normalized_groups)
...
## save trained models
type = 1  # type of pretrained model
