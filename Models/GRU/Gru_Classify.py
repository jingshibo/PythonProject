...
emg_feature_data = Data_Preparation.removeSomeSamples(emg_features, start_index=0, end_index=16)  # 0, 16, 32, 48
...
average_accuracy, overall_accuracy, sum_cm = MV_Results_ByGroup.averageAccuracy(accuracy_with_prior, cm_with_prior)
