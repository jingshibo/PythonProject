...
def classifyCnnGruLastOneModel(shuffled_groups):
    ...
    for group_number, group_value in shuffled_groups.items():
        ...
        x = tf.keras.layers.Conv2D(32, 3, dilation_rate=2, padding='same', data_format='channels_last')(cnn_inputs)
        ...
        x = tf.keras.layers.GRU(500, return_sequences=True, dropout=0)(x)
        x = tf.keras.layers.GRU(500, return_sequences=False, dropout=0)(x)
