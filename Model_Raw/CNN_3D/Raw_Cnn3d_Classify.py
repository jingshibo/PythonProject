...
from Model_Raw.CNN_3D.Functions import Raw_Cnn3d_Model
...
for group_number, group_value in shuffled_groups.items():
    group_value['train_feature_x'] = np.reshape(group_value['train_feature_x'], (feature_window_size, 65, 2, -1), "F")
    group_value['test_feature_x'] = np.reshape(group_value['test_feature_x'], (feature_window_size, 65, 2, -1), "F")
...
train_model = Raw_Cnn3d_Model.ModelTraining(num_epochs, batch_size, report_period=10)
