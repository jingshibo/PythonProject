...
## filtering EMG data
def filterEmg(emg_measurements, lower_limit=20, higher_limit=400, notch=False, median_filtering=True, quality_factor=10):
    sos = signal.butter(4, [lower_limit, higher_limit], fs=2000, btype="bandpass", output='sos')
