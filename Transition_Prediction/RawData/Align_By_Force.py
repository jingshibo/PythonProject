...
emg_start_index = 8945  # select the index belonging to the pulse number where the insole start_index is
emg_end_index = 330866  # select the index belonging to the pulse number where the insole end_index is
