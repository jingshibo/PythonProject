...
model_results = Cnn_Model.classifyTransferCnnModel(shuffled_groups, models)
...
average_accuracy, sum_cm = MV_Results_ByGroup.averageAccuracyByGroup(accuracy, cm)
